...
Experiência em arquitetura de APIs RESTful, implementação de segurança com Spring Security/JWT e persistência de dados com JPA.
...
- Desenvolvimento de automações em Python para integração e orquestração de fluxos de dados entre sistemas legados e modernos.
- Modelagem e otimização de bancos de dados SQL Server, desenvolvendo estruturas complexas para garantir a integridade de dados críticos.
- Aplicação de modelos preditivos e algoritmos de análise para otimização de processos internos de TI.
- Manutenção de dashboards no Power BI integrados via SQL para suporte estratégico ao negócio.
...
## FORMAÇÃO ACADÊMICA
- **Especialização Java Full Stack** - FACINT (Em andamento).
- **MBA em Ciência de Dados** - PUC-Rio.
- **Bacharelado em Sistemas de Informação** - UNIRIO.
- **Bacharelado em Engenharia Química** - UFF.
